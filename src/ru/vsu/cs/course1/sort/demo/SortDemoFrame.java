...
public class SortDemoFrame extends JFrame {
    ...
    private JButton shellSortPerformanceButton;
...
//-------------------------------------------------------------------
        shellSortPerformanceButton.addActionListener(actionEvent -> {
            String[] sortNames = {
                    "Stock",
                    "PaperStansevich",
                    "Sedgewigck",
            ...
            @SuppressWarnings("unchecked")
            Consumer<int[]>[] sorts = new Consumer[]{
                    (Consumer<int[]>) ShellSort::sortStock,
                    (Consumer<int[]>) ShellSort::sortPaperStansevich,
                    (Consumer<int[]>) ShellSort::sortSedgewigck,
                    (Consumer<int[]>) ShellSort::sortHibbard,
            ...
            performanceTestDemoShell(sortNames, sorts, sizes);
        });
...
//implementation of shellsort performance test

    private static double[][] performanceTestShell(Consumer<int[]>[] sorts, int[] sizes) {
        Random rnd = new Random();
        double[][] result = new double[sorts.length][sizes.length];
    ...
    private void performanceTestDemoShell(String[] sortNames, Consumer<int[]>[] sorts, int[] sizes) {
        double[][] result = performanceTestShell(sorts, sizes);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panelMain.add(panelPerformance, new GridConstraints(4, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(-1, 300), null, 0, false));
        ...
        shellSortButton = new JButton();
        shellSortButton.setText("ShellSort");
        panelMain.add(shellSortButton, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        shellSortPerformanceButton = new JButton();
        shellSortPerformanceButton.setText("ShellSortPerformance");
        panelMain.add(shellSortPerformanceButton, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
